 ...
 */
#ifndef SRC_FASTER_R_LOCAL_SIMULATOR_H_
#define SRC_FASTER_R_LOCAL_SIMULATOR_H_

#include <vector>
#include <string>
#include "src/simulator.h"

class FasterrLocalSimulator : public Simulator {
 public:
...
#endif  // SRC_FASTER_R_LOCAL_SIMULATOR_H_
